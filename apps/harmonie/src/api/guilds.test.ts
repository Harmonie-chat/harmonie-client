...
describe('guilds api', () => {
  ...
  it('lists guilds and channels', async () => {
    ...
    expect(apiFetchMock).toHaveBeenNthCalledWith(1, 'https://localhost:5000/api/guilds');
    expect(apiFetchMock).toHaveBeenNthCalledWith(
      2,
      'https://localhost:5000/api/guilds/guild-1/channels'
    );
  });
  ...
  it('creates, updates, and reorders guild resources with JSON bodies', async () => {
    ...
    expect(
      ...
      ['https://localhost:5000/api/guilds', 'POST'],
      ['https://localhost:5000/api/guilds/guild-1', 'PATCH'],
      ['https://localhost:5000/api/guilds/guild-1/channels/reorder', 'PATCH'],
      ['https://localhost:5000/api/guilds/guild-1/channels', 'POST'],
    ]);
