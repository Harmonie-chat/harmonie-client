export const en = {
  ...
  channel: {
    messages: {
      ...
      openMemberProfile: 'Open {{name}} profile',
  ...
  voice: {
    ...
    noCaptionsAvailable: 'Captions unavailable',
  ...
  conversation: {
    ...
    removeParticipant: 'Remove {{name}} from the conversation',
    noResults: 'No results',
  ...
  auth: {
    ...
    hostLinkLabel: 'View Harmonie on GitHub',
    or: 'or',
